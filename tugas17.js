...
var kalimat = "Allen Sedang MemAncing IkaN di SuNgai, DIA MEndapat IkAN GaBuS 3 Ekor dan LanGsuNg Dijual."
console.log(kalimat.toLowerCase())
console.log(kalimat.toUpperCase())
...
console.log(
	kalimat.charCodeAt(0),'-',
	kalimat.charCodeAt(1),'-',
	kalimat.charCodeAt(2),'-',
	kalimat.charCodeAt(3),'-',
	kalimat.charCodeAt(4),'-',
	kalimat.charCodeAt(5));
}
codeAT()
